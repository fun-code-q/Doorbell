...
const I18n = {
  ...
  translations: {
    en: {
      ...
      send_button: "Transmit",
      encrypted: "Secure Connection",
      how_it_works: "Security Overview",
      instruction_desc: "Your entry request is end-to-end encrypted. The owner will respond shortly. Please keep this window open for the reply.",
      ...
      master_pin_placeholder: "Master Encryption PIN",
      sign_out: "Sign Out",
      dashboard: "Console",
      ...
      security: "Protocol",
      master_pin: "Security PIN",
      master_pin_hint: "Private key for message decryption.",
      analytics: "Traffic",
